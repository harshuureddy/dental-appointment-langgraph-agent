...
SYSTEM_PROMPT = """
You are a helpful dental appointment assistant. You help patients with:
...
def _pre_model_hook(state: dict) -> dict:
    ...
    Sanitizes messages and prepends the dental assistant
    system prompt without modifying the stored state.
    """
